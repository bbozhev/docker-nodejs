...
# FROM alpine:3.9
# ENV VERSION=v12.19.1 NPM_VERSION=6 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python

#FROM alpine:3.12
#ENV VERSION=v15.2.1 NPM_VERSION=7 YARN_VERSION=v1.22.10 NODE_BUILD_PYTHON=python3

FROM alpine:3.12
ENV VERSION=v15.3.0 NPM_VERSION=7.0.14 YARN_VERSION=latest NODE_BUILD_PYTHON=python3
